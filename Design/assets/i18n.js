(function () {
  ...
  var ru = {
    ...
    'Nukus, Qaraqalpaqstan': 'Нукус, Каракалпакстан',
    ...
    'Welcome to Damir Hotel': 'Добро пожаловать в Damir Hotel',
    ...
    'At Qaraqalpaqstan, 6 A, Nukus, close to the Savitsky Museum, local bazaar and about 1.5 km from Nukus Airport.': 'Адрес: Qaraqalpaqstan, 6 A, Nukus. Рядом музей Савицкого, базар, до аэропорта около 1,5 км.',
    ...
    'Every room at Damir Hotel includes air conditioning, a private bathroom, flat-screen TV, free Wi-Fi, tea and coffee facilities, city views and terrace access. Breakfast is included, and no prepayment is needed for direct reservation inquiries.': 'В каждом номере Damir Hotel есть кондиционер, отдельная ванная, телевизор, бесплатный Wi-Fi, чай и кофе, вид на город и выход на террасу. Завтрак включен, предоплата для прямого запроса не нужна.',
    ...
    'Set at Qaraqalpaqstan, 6 A, Nukus, close to the Savitsky Museum, local bazaar and river area.': 'Адрес Qaraqalpaqstan, 6 A: рядом музей Савицкого, местный базар и район у реки.',
    ...
    'Mornings at Damir Hotel begin with a buffet of hot and cold dishes, sweet and savoury choices, fresh fruit, salads, breads, tea and coffee.': 'Утро в Damir Hotel начинается со шведского стола: горячие и холодные блюда, сладкие и несладкие варианты, фрукты, салаты, хлеб, чай и кофе.',
  ...
  var uz = {
    ...
    'Nukus, Qaraqalpaqstan': 'Nukus, Qoraqalpog‘iston',
    ...
    'Welcome to Damir Hotel': 'Damir Hotelga xush kelibsiz',
    ...
    'Location': 'Joylashuv',
    'At Qaraqalpaqstan, 6 A, Nukus, close to the Savitsky Museum, local bazaar and about 1.5 km from Nukus Airport.': 'Nukusdagi Qaraqalpaqstan, 6 A manzilida, Savitskiy muzeyi va bozori yaqinida, aeroportdan taxminan 1,5 km.',
    ...
    'A quiet landmark of warm hospitality in Nukus, Qaraqalpaqstan — considered rooms, generous breakfasts and the kind of calm that makes a stay feel like a retreat.': 'Nukus, Qoraqalpog‘istondagi samimiy mehmondo‘stlik maskani: puxta xonalar, to‘yimli nonushta va safarni dam olishdek his qildiradigan sokinlik.',
    ...
    'Set at Qaraqalpaqstan, 6 A, Nukus, close to the Savitsky Museum, local bazaar and river area.': 'Qaraqalpaqstan, 6 A manzilida, Savitskiy muzeyi, mahalliy bozor va daryo hududiga yaqin.',
    ...
    'Mornings at Damir Hotel begin with a buffet of hot and cold dishes, sweet and savoury choices, fresh fruit, salads, breads, tea and coffee.': 'Damir Hotelda tong issiq va sovuq taomlar, shirin va sho‘r tanlovlar, mevalar, salatlar, non, choy va qahvali bufet bilan boshlanadi.',
  ...
  function addSwitcher() {
    ...
    var headerRight = doc.querySelector('.nav-right');
    if (headerRight) {
