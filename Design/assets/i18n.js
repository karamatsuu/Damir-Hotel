(function () {
  ...
  var ru = {
    ...
    'Nukus, Uzbekistan': 'Нукус, Узбекистан',
    'Quiet luxury,': 'Спокойная роскошь,',
    'warmly kept.': 'с теплым приемом.',
    'Damir Hotel is a calm retreat of oak-warmed rooms, generous breakfasts and unhurried service — a considered base for work or rest.': 'Damir Hotel — спокойное место с теплыми интерьерами, сытными завтраками и внимательным сервисом для работы и отдыха.',
    'Check-in': 'Заезд',
    'Check-out': 'Выезд',
    'Guests': 'Гости',
    '1 guest': '1 гость',
    ...
    'Welcome to Damir': 'Добро пожаловать в Damir',
    ...
    'From a 24-hour welcome at reception to a daily buffet breakfast, free private parking and a central Nukus address near the Savitsky Museum, Damir Hotel is built to make a stay feel effortless.': 'Круглосуточная стойка регистрации, ежедневный завтрак «шведский стол», бесплатная частная парковка и центральное расположение рядом с музеем Савицкого делают пребывание простым и комфортным.',
    ...
    'At Рауаж 4 in Nukus, close to the Savitsky Museum, local bazaar and about 2.2 km from Nukus Airport.': 'Адрес: Рауаж 4, Нукус. Рядом музей Савицкого, базар, до аэропорта Нукуса около 2,2 км.',
    'Directions': 'Как добраться',
    'Very good rating': 'Оценка гостей',
    ...
    'Explore': 'Навигация',
    'Stay': 'Проживание',
    'Рауаж 4, 230100 Nukus': 'Рауаж 4, 230100 Нукус',
    'Reception open 24 hours': 'Стойка регистрации работает 24 часа',
    'A quiet landmark of warm hospitality in Nukus, Uzbekistan — considered rooms, generous breakfasts and the kind of calm that makes a stay feel like a retreat.': 'Тихий ориентир теплого гостеприимства в Нукусе: продуманные номера, щедрые завтраки и спокойствие, которое делает поездку похожей на отдых.',
    'DAMIR HOTEL': 'DAMIR HOTEL',
    ...
    'Double or Twin Room': 'Номер Double или Twin',
    ...
    'Thank you': 'Спасибо',
    'Your request has reached our reservations desk. We\'ll be in touch shortly to confirm your stay at Damir Hotel.': 'Ваш запрос отправлен в отдел бронирования. Мы скоро свяжемся с вами для подтверждения.',
    ...
    'Every room at Damir includes air conditioning, a private bathroom, flat-screen TV, free Wi-Fi, tea and coffee facilities, city views and terrace access. Breakfast is included, and no prepayment is needed for direct reservation inquiries.': 'В каждом номере Damir есть кондиционер, отдельная ванная, телевизор, бесплатный Wi-Fi, чай и кофе, вид на город и выход на террасу. Завтрак включен, предоплата для прямого запроса не нужна.',
    ...
    'Set at Рауаж 4, close to the Savitsky Museum, local bazaar and river area.': 'Адрес Рауаж 4: рядом музей Савицкого, местный базар и район у реки.',
    'Easy Arrival': 'Легкий приезд',
    'Nukus Airport is about 2.2 km away, with shuttle service available on request.': 'Аэропорт Нукуса примерно в 2,2 км, трансфер доступен по запросу.',
    ...
    'Mornings at Damir begin with a buffet of hot and cold dishes, sweet and savoury choices, fresh fruit, salads, breads, tea and coffee.': 'Утро в Damir начинается со шведского стола: горячие и холодные блюда, сладкие и несладкие варианты, фрукты, салаты, хлеб, чай и кофе.',
  ...
  var uz = {
    ...
    'Nukus, Uzbekistan': 'Nukus, O‘zbekiston',
    'Quiet luxury,': 'Sokin qulaylik,',
    'warmly kept.': 'samimiy mehmondo‘stlik.',
    'Damir Hotel is a calm retreat of oak-warmed rooms, generous breakfasts and unhurried service — a considered base for work or rest.': 'Damir Hotel — iliq interyerli xonalar, to‘yimli nonushta va e’tiborli xizmatga ega sokin maskan.',
    'Check-in': 'Kirish',
    'Check-out': 'Chiqish',
    'Guests': 'Mehmonlar',
    '1 guest': '1 mehmon',
    ...
    'Welcome to Damir': 'Damirga xush kelibsiz',
    ...
    'Location': 'Joylashuv',
    'At Рауаж 4 in Nukus, close to the Savitsky Museum, local bazaar and about 2.2 km from Nukus Airport.': 'Nukusdagi Рауаж 4 manzilida, Savitskiy muzeyi va bozori yaqinida, aeroportdan taxminan 2,2 km.',
    'Directions': 'Yo‘nalish',
    'Very good rating': 'Mehmonlar bahosi',
    ...
    'Explore': 'Bo‘limlar',
    'Stay': 'Turar joy',
    'Рауаж 4, 230100 Nukus': 'Рауаж 4, 230100 Nukus',
    'Reception open 24 hours': 'Resepshn 24 soat ochiq',
    'A quiet landmark of warm hospitality in Nukus, Uzbekistan — considered rooms, generous breakfasts and the kind of calm that makes a stay feel like a retreat.': 'Nukusdagi samimiy mehmondo‘stlik maskani: puxta xonalar, to‘yimli nonushta va safarni dam olishdek his qildiradigan sokinlik.',
    ...
    'Twin Room': 'Twin xona',
    'Double or Twin Room': 'Double yoki Twin xona',
    ...
    'Thank you': 'Rahmat',
    'Your request has reached our reservations desk. We\'ll be in touch shortly to confirm your stay at Damir Hotel.': 'So‘rovingiz bron bo‘limiga yuborildi. Tez orada tasdiqlash uchun bog‘lanamiz.',
    ...
    'Damir Hotel was built on a simple belief: that real luxury is quiet. Behind a stately white exterior, we made interiors that feel calm and contemporary — warm oak joinery, honed stone, soft light and space used generously.': 'Damir Hotel oddiy fikrga asoslangan: haqiqiy qulaylik sokin bo‘ladi. Oq fasad ortida iliq yog‘och, tosh, yumshoq yorug‘lik va puxta rejalangan joylar bor.',
    ...
    'Set at Рауаж 4, close to the Savitsky Museum, local bazaar and river area.': 'Рауаж 4 manzilida, Savitskiy muzeyi, mahalliy bozor va daryo hududiga yaqin.',
    'Easy Arrival': 'Oson kelish',
    'Nukus Airport is about 2.2 km away, with shuttle service available on request.': 'Nukus aeroporti taxminan 2,2 km uzoqlikda, transfer so‘rov bo‘yicha mavjud.',
    ...
    'Damir Hotel sits within easy reach of Nukus\'s key connections, with secure on-site parking and an airport shuttle available on request. Whether you\'re here for business, museum visits or a short stay between trips, arrival is simple.': 'Damir Hotel Nukusdagi asosiy joylarga yaqin, xususiy avtoturargoh va aeroport transferi mavjud. Ish, muzey yoki qisqa safar uchun kelish oson.',
    ...
    'Mornings at Damir begin with a buffet of hot and cold dishes, sweet and savoury choices, fresh fruit, salads, breads, tea and coffee.': 'Damirda tong issiq va sovuq taomlar, shirin va sho‘r tanlovlar, mevalar, salatlar, non, choy va qahvali bufet bilan boshlanadi.',
